...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/FaisalTamanoJr/dotfiles.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/FaisalTamanoJr/install_script/master/progs.csv"
